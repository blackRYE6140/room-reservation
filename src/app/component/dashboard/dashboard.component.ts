...
export class DashboardComponent {
  ...
  getDataAndUpdateChart1() {
    this.http.get<any>('https://render-api-1-3u8t.onrender.com/api/dashboard/nat').subscribe(
      (res) => {
        const data = res.data;
    ...
    getDataAndUpdateChart2() {
      this.http.get<any>('https://render-api-1-3u8t.onrender.com/api/dashboard/clientNbr-by-date').subscribe(
        (res) => {
          const data = res.data;
  ...
  getDataAndUpdateChart3() {
    this.http.get<any>('https://render-api-1-3u8t.onrender.com/api/dashboard/sum-by-month').subscribe(
      (res) => {
        const data = res.data;
